import { type Grade, type Student } from "./api";

// TODO: remove
export { type Student };

let baseLatency = parseFloat(
  localStorage.getItem("fakeApi:fakeLatency") ?? "0",
);
    ...
    if (typeof val === "function") {
      result[key] = (...args) =>
        new Promise((resolve) => {
          ...
          const timeout = baseLatency + Math.random() * latencyVariance;
